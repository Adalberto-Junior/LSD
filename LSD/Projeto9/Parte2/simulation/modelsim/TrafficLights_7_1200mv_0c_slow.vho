...
SIGNAL \main_fsm|s_currentState.TYellowFix~q\ : std_logic;
...
-- Equation(s):
-- \main_fsm|Selector5~0_combout\ = (\SW[0]~input_o\ & (((\main_fsm|s_currentState.TYellowFix~q\)))) # (!\SW[0]~input_o\ & ((\timer_fsm|s_cntZero~q\ & (\main_fsm|s_currentState.TIntermit~q\)) # (!\timer_fsm|s_cntZero~q\ & 
-- ((\main_fsm|s_currentState.TYellowFix~q\)))))
...
PORT MAP (
	...
	datab => \SW[0]~input_o\,
	datac => \main_fsm|s_currentState.TYellowFix~q\,
	datad => \timer_fsm|s_cntZero~q\,
...
\main_fsm|s_currentState.TYellowFix\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \main_fsm|s_currentState.TYellowFix~q\);

-- Location: LCCOMB_X107_Y38_N30
\main_fsm|sync_proc~13\ : cycloneive_lcell_comb
-- Equation(s):
-- \main_fsm|sync_proc~13_combout\ = (!\SW[0]~input_o\ & (\timer_fsm|s_cntZero~q\ & (\main_fsm|s_currentState.TIntermit~q\ $ (\main_fsm|s_currentState.TYellowFix~q\))))
...
-- Equation(s):
-- \main_fsm|Selector6~0_combout\ = (\timer_fsm|s_cntZero~q\ & ((\main_fsm|s_currentState.TYellow1~q\) # ((!\SW[0]~input_o\ & \main_fsm|s_currentState.TYellowFix~q\))))
...
-- Equation(s):
-- \main_fsm|WideOr8~combout\ = (\main_fsm|s_currentState.TGreen2~q\) # ((\main_fsm|s_currentState.TRed1~q\) # ((\main_fsm|s_currentState.TYellowFix~q\) # (\main_fsm|s_currentState.TRed2~q\)))
...
-- Equation(s):
-- \LEDR~0_combout\ = (\main_fsm|s_currentState.TIntermit~q\ & (((\clk_div_1hz|clkOut~q\)))) # (!\main_fsm|s_currentState.TIntermit~q\ & ((\main_fsm|s_currentState.TYellowFix~q\) # ((\main_fsm|s_currentState.TYellow2~q\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \main_fsm|s_currentState.TYellowFix~q\,
...
-- Equation(s):
-- \LEDR~1_combout\ = (\main_fsm|s_currentState.TIntermit~q\ & (((\clk_div_1hz|clkOut~q\)))) # (!\main_fsm|s_currentState.TIntermit~q\ & ((\main_fsm|s_currentState.TYellowFix~q\) # ((\main_fsm|s_currentState.TYellow1~q\))))
