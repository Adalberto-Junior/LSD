...
-- Equation(s):
-- \system_core|outputs[0]~0_combout\ = (\SW[2]~input_o\ & (!\SW[1]~input_o\ & !\SW[0]~input_o\))
...
-- Equation(s):
-- \system_core|outputs[1]~1_combout\ = (\SW[0]~input_o\ & (\SW[2]~input_o\ & !\SW[1]~input_o\))
...
-- Equation(s):
-- \system_core|outputs[3]~3_combout\ = (\SW[1]~input_o\ & (\SW[0]~input_o\ & \SW[2]~input_o\))
