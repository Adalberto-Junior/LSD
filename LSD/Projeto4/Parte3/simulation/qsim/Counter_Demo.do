...
vcom -work work CounterLoadUpDown4.vwf.vht
vsim -novopt -c -t 1ps -L cycloneive -L altera -L altera_mf -L 220model -L sgate -L altera_lnsim work.CounterLoadUpDown4_vhd_vec_tst
