...
SIGNAL \inst2|s_counter~11_combout\ : std_logic;
...
SIGNAL \inst2|s_counter\ : std_logic_vector(30 DOWNTO 0);
...
-- Equation(s):
-- \inst2|Add0~0_combout\ = \inst2|s_counter\(0) $ (VCC)
-- \inst2|Add0~1\ = CARRY(\inst2|s_counter\(0))
...
-- Equation(s):
-- \inst2|Add0~2_combout\ = (\inst2|s_counter\(1) & (!\inst2|Add0~1\)) # (!\inst2|s_counter\(1) & ((\inst2|Add0~1\) # (GND)))
-- \inst2|Add0~3\ = CARRY((!\inst2|Add0~1\) # (!\inst2|s_counter\(1)))
...
-- Equation(s):
-- \inst2|Equal0~10_combout\ = (\inst2|s_counter\(1) & \inst2|s_counter\(0))
...
PORT MAP (
	...
	datad => \inst2|s_counter\(0),
	combout => \inst2|Equal0~10_combout\);

-- Location: LCCOMB_X53_Y4_N6
\inst2|Add0~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst2|Add0~4_combout\ = (\inst2|s_counter\(2) & (\inst2|Add0~3\ $ (GND))) # (!\inst2|s_counter\(2) & (!\inst2|Add0~3\ & VCC))
-- \inst2|Add0~5\ = CARRY((\inst2|s_counter\(2) & !\inst2|Add0~3\))
...
-- Equation(s):
-- \inst2|Add0~6_combout\ = (\inst2|s_counter\(3) & (!\inst2|Add0~5\)) # (!\inst2|s_counter\(3) & ((\inst2|Add0~5\) # (GND)))
-- \inst2|Add0~7\ = CARRY((!\inst2|Add0~5\) # (!\inst2|s_counter\(3)))
...
-- Equation(s):
-- \inst2|Add0~8_combout\ = (\inst2|s_counter\(4) & (\inst2|Add0~7\ $ (GND))) # (!\inst2|s_counter\(4) & (!\inst2|Add0~7\ & VCC))
-- \inst2|Add0~9\ = CARRY((\inst2|s_counter\(4) & !\inst2|Add0~7\))
...
-- Equation(s):
-- \inst2|Add0~10_combout\ = (\inst2|s_counter\(5) & (!\inst2|Add0~9\)) # (!\inst2|s_counter\(5) & ((\inst2|Add0~9\) # (GND)))
-- \inst2|Add0~11\ = CARRY((!\inst2|Add0~9\) # (!\inst2|s_counter\(5)))
...
-- Equation(s):
-- \inst2|Equal0~5_combout\ = (\inst2|s_counter\(4) & (\inst2|s_counter\(2) & (\inst2|s_counter\(5) & \inst2|s_counter\(3))))
...
PORT MAP (
	...
	datad => \inst2|s_counter\(3),
	combout => \inst2|Equal0~5_combout\);

-- Location: LCCOMB_X53_Y4_N14
\inst2|Add0~12\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst2|Add0~12_combout\ = (\inst2|s_counter\(6) & (\inst2|Add0~11\ $ (GND))) # (!\inst2|s_counter\(6) & (!\inst2|Add0~11\ & VCC))
-- \inst2|Add0~13\ = CARRY((\inst2|s_counter\(6) & !\inst2|Add0~11\))
...
-- Equation(s):
-- \inst2|Add0~14_combout\ = (\inst2|s_counter\(7) & (!\inst2|Add0~13\)) # (!\inst2|s_counter\(7) & ((\inst2|Add0~13\) # (GND)))
-- \inst2|Add0~15\ = CARRY((!\inst2|Add0~13\) # (!\inst2|s_counter\(7)))
...
\inst2|s_counter~11\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst2|s_counter~11_combout\ = (!\inst2|Equal0~11_combout\ & \inst2|Add0~14_combout\)
...
PORT MAP (
	...
	combout => \inst2|s_counter~11_combout\);
...
-- Equation(s):
-- \inst2|Add0~16_combout\ = (\inst2|s_counter\(8) & (\inst2|Add0~15\ $ (GND))) # (!\inst2|s_counter\(8) & (!\inst2|Add0~15\ & VCC))
-- \inst2|Add0~17\ = CARRY((\inst2|s_counter\(8) & !\inst2|Add0~15\))
...
-- Equation(s):
-- \inst2|Add0~18_combout\ = (\inst2|s_counter\(9) & (!\inst2|Add0~17\)) # (!\inst2|s_counter\(9) & ((\inst2|Add0~17\) # (GND)))
-- \inst2|Add0~19\ = CARRY((!\inst2|Add0~17\) # (!\inst2|s_counter\(9)))
...
-- Equation(s):
-- \inst2|Add0~20_combout\ = (\inst2|s_counter\(10) & (\inst2|Add0~19\ $ (GND))) # (!\inst2|s_counter\(10) & (!\inst2|Add0~19\ & VCC))
-- \inst2|Add0~21\ = CARRY((\inst2|s_counter\(10) & !\inst2|Add0~19\))
...
-- Equation(s):
-- \inst2|Add0~22_combout\ = (\inst2|s_counter\(11) & (!\inst2|Add0~21\)) # (!\inst2|s_counter\(11) & ((\inst2|Add0~21\) # (GND)))
-- \inst2|Add0~23\ = CARRY((!\inst2|Add0~21\) # (!\inst2|s_counter\(11)))
...
-- Equation(s):
-- \inst2|Add0~24_combout\ = (\inst2|s_counter\(12) & (\inst2|Add0~23\ $ (GND))) # (!\inst2|s_counter\(12) & (!\inst2|Add0~23\ & VCC))
-- \inst2|Add0~25\ = CARRY((\inst2|s_counter\(12) & !\inst2|Add0~23\))
...
-- Equation(s):
-- \inst2|s_counter~10_combout\ = (\inst2|Add0~24_combout\ & !\inst2|Equal0~11_combout\)
...
-- Equation(s):
-- \inst2|Add0~26_combout\ = (\inst2|s_counter\(13) & (!\inst2|Add0~25\)) # (!\inst2|s_counter\(13) & ((\inst2|Add0~25\) # (GND)))
-- \inst2|Add0~27\ = CARRY((!\inst2|Add0~25\) # (!\inst2|s_counter\(13)))
...
-- Equation(s):
-- \inst2|s_counter~9_combout\ = (!\inst2|Equal0~11_combout\ & \inst2|Add0~26_combout\)
...
-- Equation(s):
-- \inst2|Add0~28_combout\ = (\inst2|s_counter\(14) & (\inst2|Add0~27\ $ (GND))) # (!\inst2|s_counter\(14) & (!\inst2|Add0~27\ & VCC))
-- \inst2|Add0~29\ = CARRY((\inst2|s_counter\(14) & !\inst2|Add0~27\))
...
-- Equation(s):
-- \inst2|s_counter~8_combout\ = (!\inst2|Equal0~11_combout\ & \inst2|Add0~28_combout\)
...
-- Equation(s):
-- \inst2|Add0~30_combout\ = (\inst2|s_counter\(15) & (!\inst2|Add0~29\)) # (!\inst2|s_counter\(15) & ((\inst2|Add0~29\) # (GND)))
-- \inst2|Add0~31\ = CARRY((!\inst2|Add0~29\) # (!\inst2|s_counter\(15)))
...
-- Equation(s):
-- \inst2|s_counter~3_combout\ = (\inst2|Add0~30_combout\ & !\inst2|Equal0~11_combout\)
...
-- Equation(s):
-- \inst2|Add0~32_combout\ = (\inst2|s_counter\(16) & (\inst2|Add0~31\ $ (GND))) # (!\inst2|s_counter\(16) & (!\inst2|Add0~31\ & VCC))
-- \inst2|Add0~33\ = CARRY((\inst2|s_counter\(16) & !\inst2|Add0~31\))
...
-- Equation(s):
-- \inst2|Add0~34_combout\ = (\inst2|s_counter\(17) & (!\inst2|Add0~33\)) # (!\inst2|s_counter\(17) & ((\inst2|Add0~33\) # (GND)))
-- \inst2|Add0~35\ = CARRY((!\inst2|Add0~33\) # (!\inst2|s_counter\(17)))
...
-- Equation(s):
-- \inst2|s_counter~2_combout\ = (\inst2|Add0~34_combout\ & !\inst2|Equal0~11_combout\)
...
-- Equation(s):
-- \inst2|Add0~36_combout\ = (\inst2|s_counter\(18) & (\inst2|Add0~35\ $ (GND))) # (!\inst2|s_counter\(18) & (!\inst2|Add0~35\ & VCC))
-- \inst2|Add0~37\ = CARRY((\inst2|s_counter\(18) & !\inst2|Add0~35\))
...
-- Equation(s):
-- \inst2|Add0~38_combout\ = (\inst2|s_counter\(19) & (!\inst2|Add0~37\)) # (!\inst2|s_counter\(19) & ((\inst2|Add0~37\) # (GND)))
-- \inst2|Add0~39\ = CARRY((!\inst2|Add0~37\) # (!\inst2|s_counter\(19)))
...
-- Equation(s):
-- \inst2|s_counter~7_combout\ = (!\inst2|Equal0~11_combout\ & \inst2|Add0~38_combout\)
...
-- Equation(s):
-- \inst2|Add0~40_combout\ = (\inst2|s_counter\(20) & (\inst2|Add0~39\ $ (GND))) # (!\inst2|s_counter\(20) & (!\inst2|Add0~39\ & VCC))
-- \inst2|Add0~41\ = CARRY((\inst2|s_counter\(20) & !\inst2|Add0~39\))
...
-- Equation(s):
-- \inst2|s_counter~6_combout\ = (!\inst2|Equal0~11_combout\ & \inst2|Add0~40_combout\)
...
-- Equation(s):
-- \inst2|Add0~42_combout\ = (\inst2|s_counter\(21) & (!\inst2|Add0~41\)) # (!\inst2|s_counter\(21) & ((\inst2|Add0~41\) # (GND)))
-- \inst2|Add0~43\ = CARRY((!\inst2|Add0~41\) # (!\inst2|s_counter\(21)))
...
-- Equation(s):
-- \inst2|s_counter~5_combout\ = (!\inst2|Equal0~11_combout\ & \inst2|Add0~42_combout\)
...
-- Equation(s):
-- \inst2|Add0~44_combout\ = (\inst2|s_counter\(22) & (\inst2|Add0~43\ $ (GND))) # (!\inst2|s_counter\(22) & (!\inst2|Add0~43\ & VCC))
-- \inst2|Add0~45\ = CARRY((\inst2|s_counter\(22) & !\inst2|Add0~43\))
...
-- Equation(s):
-- \inst2|s_counter~4_combout\ = (!\inst2|Equal0~11_combout\ & \inst2|Add0~44_combout\)
...
-- Equation(s):
-- \inst2|Add0~46_combout\ = (\inst2|s_counter\(23) & (!\inst2|Add0~45\)) # (!\inst2|s_counter\(23) & ((\inst2|Add0~45\) # (GND)))
-- \inst2|Add0~47\ = CARRY((!\inst2|Add0~45\) # (!\inst2|s_counter\(23)))
...
-- Equation(s):
-- \inst2|s_counter~1_combout\ = (\inst2|Add0~46_combout\ & !\inst2|Equal0~11_combout\)
...
-- Equation(s):
-- \inst2|Add0~48_combout\ = (\inst2|s_counter\(24) & (\inst2|Add0~47\ $ (GND))) # (!\inst2|s_counter\(24) & (!\inst2|Add0~47\ & VCC))
-- \inst2|Add0~49\ = CARRY((\inst2|s_counter\(24) & !\inst2|Add0~47\))
...
-- Equation(s):
-- \inst2|Add0~50_combout\ = (\inst2|s_counter\(25) & (!\inst2|Add0~49\)) # (!\inst2|s_counter\(25) & ((\inst2|Add0~49\) # (GND)))
-- \inst2|Add0~51\ = CARRY((!\inst2|Add0~49\) # (!\inst2|s_counter\(25)))
...
-- Equation(s):
-- \inst2|Add0~52_combout\ = (\inst2|s_counter\(26) & (\inst2|Add0~51\ $ (GND))) # (!\inst2|s_counter\(26) & (!\inst2|Add0~51\ & VCC))
-- \inst2|Add0~53\ = CARRY((\inst2|s_counter\(26) & !\inst2|Add0~51\))
...
-- Equation(s):
-- \inst2|Add0~54_combout\ = (\inst2|s_counter\(27) & (!\inst2|Add0~53\)) # (!\inst2|s_counter\(27) & ((\inst2|Add0~53\) # (GND)))
-- \inst2|Add0~55\ = CARRY((!\inst2|Add0~53\) # (!\inst2|s_counter\(27)))
...
-- Equation(s):
-- \inst2|Add0~56_combout\ = (\inst2|s_counter\(28) & (\inst2|Add0~55\ $ (GND))) # (!\inst2|s_counter\(28) & (!\inst2|Add0~55\ & VCC))
-- \inst2|Add0~57\ = CARRY((\inst2|s_counter\(28) & !\inst2|Add0~55\))
...
-- Equation(s):
-- \inst2|Add0~58_combout\ = (\inst2|s_counter\(29) & (!\inst2|Add0~57\)) # (!\inst2|s_counter\(29) & ((\inst2|Add0~57\) # (GND)))
-- \inst2|Add0~59\ = CARRY((!\inst2|Add0~57\) # (!\inst2|s_counter\(29)))
...
-- Equation(s):
-- \inst2|Add0~60_combout\ = \inst2|s_counter\(30) $ (!\inst2|Add0~59\)
...
-- Equation(s):
-- \inst2|Equal0~0_combout\ = (!\inst2|s_counter\(28) & (!\inst2|s_counter\(27) & (!\inst2|s_counter\(30) & !\inst2|s_counter\(29))))
...
PORT MAP (
	dataa => \inst2|s_counter\(28),
	datab => \inst2|s_counter\(27),
	datac => \inst2|s_counter\(30),
	datad => \inst2|s_counter\(29),
	combout => \inst2|Equal0~0_combout\);

-- Location: LCCOMB_X52_Y3_N24
\inst2|Equal0~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst2|Equal0~1_combout\ = (\inst2|s_counter\(22) & (\inst2|s_counter\(21) & (\inst2|s_counter\(20) & !\inst2|s_counter\(26))))
...
-- Equation(s):
-- \inst2|Equal0~2_combout\ = (\inst2|s_counter\(13) & (\inst2|s_counter\(14) & (\inst2|s_counter\(19) & \inst2|s_counter\(12))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst2|s_counter\(13),
	datab => \inst2|s_counter\(14),
	datac => \inst2|s_counter\(19),
	datad => \inst2|s_counter\(12),
	combout => \inst2|Equal0~2_combout\);

-- Location: LCCOMB_X52_Y3_N20
\inst2|Equal0~3\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst2|Equal0~3_combout\ = (!\inst2|s_counter\(10) & (!\inst2|s_counter\(7) & (!\inst2|s_counter\(9) & !\inst2|s_counter\(8))))
...
PORT MAP (
	dataa => \inst2|s_counter\(10),
	datab => \inst2|s_counter\(7),
	datac => \inst2|s_counter\(9),
	datad => \inst2|s_counter\(8),
...
-- Equation(s):
-- \inst2|Equal0~11_combout\ = (\inst2|Equal0~10_combout\ & (\inst2|Equal0~5_combout\ & (\inst2|Equal0~9_combout\ & \inst2|Equal0~4_combout\)))
...
-- Equation(s):
-- \inst2|s_counter~0_combout\ = (!\inst2|Equal0~11_combout\ & \inst2|Add0~50_combout\)
...
-- Equation(s):
-- \inst2|Equal0~7_combout\ = (\inst2|s_counter\(25) & (!\inst2|s_counter\(24) & (!\inst2|s_counter\(18) & \inst2|s_counter\(23))))
...
-- Equation(s):
-- \inst2|Equal0~8_combout\ = (!\inst2|s_counter\(16) & (\inst2|s_counter\(17) & (!\inst2|s_counter\(11) & \inst2|s_counter\(15))))
...
PORT MAP (
	...
	datab => \inst2|s_counter\(17),
	datac => \inst2|s_counter\(11),
	datad => \inst2|s_counter\(15),
	combout => \inst2|Equal0~8_combout\);

-- Location: LCCOMB_X54_Y3_N12
\inst2|Equal0~9\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst2|Equal0~9_combout\ = (\inst2|Equal0~7_combout\ & (\inst2|s_counter\(6) & \inst2|Equal0~8_combout\))
...
-- Equation(s):
-- \inst2|clkOut~0_combout\ = (!\inst2|s_counter\(25) & (\inst2|s_counter\(24) & (\inst2|s_counter\(18) & !\inst2|s_counter\(23))))
...
-- Equation(s):
-- \inst2|clkOut~1_combout\ = (\inst2|s_counter\(16) & (!\inst2|s_counter\(17) & (\inst2|s_counter\(11) & !\inst2|s_counter\(15))))
...
-- Equation(s):
-- \inst2|clkOut~2_combout\ = (\inst2|clkOut~0_combout\ & (!\inst2|s_counter\(6) & \inst2|clkOut~1_combout\))
...
-- Equation(s):
-- \inst2|Equal0~6_combout\ = (\inst2|s_counter\(1) & (\inst2|Equal0~5_combout\ & (\inst2|s_counter\(0) & \inst2|Equal0~4_combout\)))
...
-- Equation(s):
-- \inst2|clkOut~3_combout\ = (\inst2|Equal0~6_combout\ & (!\inst2|Equal0~9_combout\ & ((\inst2|clkOut~q\) # (\inst2|clkOut~2_combout\)))) # (!\inst2|Equal0~6_combout\ & (\inst2|clkOut~q\))
