...
SIGNAL \inst|timerOut~3_combout\ : std_logic;
...
-- Equation(s):
-- \inst|s_count[0]~37_combout\ = (\SW[2]~input_o\) # ((\SW[0]~input_o\ & ((\SW[1]~input_o\) # (!\inst|Equal0~10_combout\))))
...
-- Equation(s):
-- \inst|Equal0~0_combout\ = (!\inst|s_count\(0) & (!\inst|s_count\(3) & (!\inst|s_count\(4) & !\inst|s_count\(5))))
...
-- Equation(s):
-- \inst|Equal0~2_combout\ = (!\inst|s_count\(10) & (!\inst|s_count\(11) & (!\inst|s_count\(12) & !\inst|s_count\(13))))
...
-- Equation(s):
-- \inst|Equal0~3_combout\ = (!\inst|s_count\(14) & (!\inst|s_count\(15) & (!\inst|s_count\(16) & !\inst|s_count\(17))))
...
-- Equation(s):
-- \inst|Equal0~5_combout\ = (!\inst|s_count\(18) & (!\inst|s_count\(19) & (!\inst|s_count\(20) & !\inst|s_count\(21))))
...
-- Equation(s):
-- \inst|Equal0~6_combout\ = (!\inst|s_count\(22) & (!\inst|s_count\(23) & (!\inst|s_count\(24) & !\inst|s_count\(25))))
...
-- Equation(s):
-- \inst|Equal0~7_combout\ = (!\inst|s_count\(26) & (!\inst|s_count\(27) & (!\inst|s_count\(28) & !\inst|s_count\(29))))
...
-- Equation(s):
-- \inst|Equal0~8_combout\ = (\inst|Equal0~7_combout\ & (!\inst|s_count\(30) & !\inst|s_count\(31)))
...
PORT MAP (
	...
	datac => \inst|s_count\(30),
	datad => \inst|s_count\(31),
	combout => \inst|Equal0~8_combout\);

\inst|Equal0~9\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|Equal0~9_combout\ = (\inst|Equal0~4_combout\ & (\inst|Equal0~5_combout\ & (\inst|Equal0~6_combout\ & \inst|Equal0~8_combout\)))
...
-- Equation(s):
-- \inst|Equal0~10_combout\ = (\inst|Equal0~9_combout\ & (!\inst|s_count\(1) & !\inst|s_count\(2)))
...
-- Equation(s):
-- \inst|s_count[0]~36_combout\ = (\SW[2]~input_o\) # ((!\inst|timerOut~0_combout\ & ((!\inst|Equal0~10_combout\) # (!\SW[1]~input_o\))))
...
-- Equation(s):
-- \inst|timerOut~0_combout\ = (\inst|s_count\(1) $ (\inst|s_count\(2))) # (!\inst|Equal0~9_combout\)
...
-- Equation(s):
-- \inst|timerOut~1_combout\ = (!\inst|s_count\(1) & (!\inst|s_count\(2) & \inst|Equal0~9_combout\))
...
-- Equation(s):
-- \inst|timerOut~2_combout\ = (\inst|timerOut~0_combout\) # ((\inst|timerOut~1_combout\ & ((\inst|timerOut~q\) # (\SW[1]~input_o\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|timerOut~q\,
	datab => \SW[1]~input_o\,
	datac => \inst|timerOut~0_combout\,
	datad => \inst|timerOut~1_combout\,
	combout => \inst|timerOut~2_combout\);

\inst|timerOut~3\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|timerOut~3_combout\ = (!\SW[2]~input_o\ & ((\SW[0]~input_o\ & ((\inst|timerOut~2_combout\))) # (!\SW[0]~input_o\ & (\inst|timerOut~q\))))
...
PORT MAP (
	...
	datad => \inst|timerOut~2_combout\,
	combout => \inst|timerOut~3_combout\);
