...
SIGNAL \inst3|s_value~0_combout\ : std_logic;
SIGNAL \SW[2]~input_o\ : std_logic;
SIGNAL \SW[1]~input_o\ : std_logic;
SIGNAL \inst3|s_value[3]~1_combout\ : std_logic;
SIGNAL \inst3|s_value~4_combout\ : std_logic;
SIGNAL \inst3|s_value~5_combout\ : std_logic;
SIGNAL \inst3|s_value~6_combout\ : std_logic;
SIGNAL \inst3|s_value[3]~2_combout\ : std_logic;
SIGNAL \inst3|s_value~3_combout\ : std_logic;
...
-- Equation(s):
-- \inst2|LessThan0~4_combout\ = (!\inst2|s_divCounter\(18) & (!\inst2|s_divCounter\(16) & !\inst2|s_divCounter\(24)))
...
-- Equation(s):
-- \inst2|LessThan0~0_combout\ = (!\inst2|s_divCounter\(18) & (!\inst2|s_divCounter\(11) & (!\inst2|s_divCounter\(16) & !\inst2|s_divCounter\(24))))
...
-- Equation(s):
-- \inst2|LessThan1~5_combout\ = (\inst2|LessThan1~1_combout\) # ((!\inst2|s_divCounter\(6) & (\inst2|LessThan1~3_combout\ & \inst2|LessThan1~4_combout\)))
...
\inst3|s_value~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|s_value~0_combout\ = (!\inst3|s_value\(0) & !\SW[0]~input_o\)
...
PORT MAP (
	...
	datad => \SW[0]~input_o\,
	combout => \inst3|s_value~0_combout\);
...
\inst3|s_value[3]~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|s_value[3]~1_combout\ = (\SW[0]~input_o\) # ((\SW[2]~input_o\ & \SW[1]~input_o\))
...
PORT MAP (
	...
	datac => \SW[1]~input_o\,
	datad => \SW[0]~input_o\,
	combout => \inst3|s_value[3]~1_combout\);
...
PORT MAP (
	...
	d => \inst3|s_value~0_combout\,
	ena => \inst3|s_value[3]~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst3|s_value\(0));

-- Location: LCCOMB_X95_Y69_N28
\inst3|s_value~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|s_value~4_combout\ = (!\SW[0]~input_o\ & (\inst3|s_value\(2) $ (((\inst3|s_value\(1) & \inst3|s_value\(0))))))
...
PORT MAP (
	...
	combout => \inst3|s_value~4_combout\);
...
\inst3|s_value~5\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|s_value~5_combout\ = (\inst3|s_value\(2) & (\inst3|s_value\(1) $ (\inst3|s_value\(3)))) # (!\inst3|s_value\(2) & (\inst3|s_value\(1) & \inst3|s_value\(3)))
...
PORT MAP (
	...
	datad => \inst3|s_value\(3),
	combout => \inst3|s_value~5_combout\);

-- Location: LCCOMB_X95_Y69_N22
\inst3|s_value~6\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|s_value~6_combout\ = (!\SW[0]~input_o\ & ((\inst3|s_value\(0) & ((\inst3|s_value~5_combout\))) # (!\inst3|s_value\(0) & (\inst3|s_value\(3)))))
...
PORT MAP (
	dataa => \SW[0]~input_o\,
	datab => \inst3|s_value\(0),
	datac => \inst3|s_value\(3),
	datad => \inst3|s_value~5_combout\,
	combout => \inst3|s_value~6_combout\);
...
\inst3|s_value[3]~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|s_value[3]~2_combout\ = (\inst3|s_value\(1)) # ((\inst3|s_value\(2)) # ((!\inst3|s_value\(0)) # (!\inst3|s_value\(3))))
...
PORT MAP (
	...
	datac => \inst3|s_value\(3),
	datad => \inst3|s_value\(0),
	combout => \inst3|s_value[3]~2_combout\);

-- Location: LCCOMB_X95_Y69_N30
\inst3|s_value~3\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|s_value~3_combout\ = (!\SW[0]~input_o\ & (\inst3|s_value[3]~2_combout\ & (\inst3|s_value\(0) $ (\inst3|s_value\(1)))))
...
PORT MAP (
	...
	datab => \inst3|s_value\(0),
	datac => \inst3|s_value\(1),
	datad => \inst3|s_value[3]~2_combout\,
	combout => \inst3|s_value~3_combout\);
...
-- Equation(s):
-- \inst|Mux0~0_combout\ = (\inst3|s_value\(3) & ((\inst3|s_value\(1) & ((!\inst3|s_value\(0)))) # (!\inst3|s_value\(1) & ((\inst3|s_value\(2)) # (\inst3|s_value\(0))))))
...
-- Equation(s):
-- \inst|Mux1~0_combout\ = (\inst3|s_value\(3) & (((\inst3|s_value\(2)) # (!\inst3|s_value\(0))))) # (!\inst3|s_value\(3) & (\inst3|s_value\(1) & (\inst3|s_value\(2) & !\inst3|s_value\(0))))
...
-- Equation(s):
-- \inst|Mux2~0_combout\ = (\inst3|s_value\(1) & ((\inst3|s_value\(3) & (!\inst3|s_value\(2) & !\inst3|s_value\(0))) # (!\inst3|s_value\(3) & (\inst3|s_value\(2)))))
...
-- Equation(s):
-- \inst|Mux3~0_combout\ = (\inst3|s_value\(1) & (\inst3|s_value\(3))) # (!\inst3|s_value\(1) & (\inst3|s_value\(2) & ((\inst3|s_value\(3)) # (\inst3|s_value\(0)))))
...
-- Equation(s):
-- \inst|Mux4~0_combout\ = (\inst3|s_value\(1) & ((\inst3|s_value\(0) & ((!\inst3|s_value\(2)))) # (!\inst3|s_value\(0) & (\inst3|s_value\(3))))) # (!\inst3|s_value\(1) & (\inst3|s_value\(2) & ((\inst3|s_value\(3)) # (!\inst3|s_value\(0)))))
...
-- Equation(s):
-- \inst|Mux5~0_combout\ = (\inst3|s_value\(3) & (\inst3|s_value\(1) & (\inst3|s_value\(2) $ (!\inst3|s_value\(0))))) # (!\inst3|s_value\(3) & (!\inst3|s_value\(0) & (\inst3|s_value\(1) $ (\inst3|s_value\(2)))))
...
-- Equation(s):
-- \inst|Mux6~0_combout\ = (\inst3|s_value\(1) & (\inst3|s_value\(3) & (!\inst3|s_value\(2) & !\inst3|s_value\(0)))) # (!\inst3|s_value\(1) & (\inst3|s_value\(0) & (\inst3|s_value\(3) $ (!\inst3|s_value\(2)))))
...
-- Equation(s):
-- \inst|Mux7~0_combout\ = (\inst3|s_value\(3) & ((\inst3|s_value\(0) & ((\inst3|s_value\(2)))) # (!\inst3|s_value\(0) & (\inst3|s_value\(1)))))
