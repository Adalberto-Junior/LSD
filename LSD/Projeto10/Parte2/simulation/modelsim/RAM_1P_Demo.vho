...
SIGNAL \RAM|s_memory~94feeder_combout\ : std_logic;
...
SIGNAL \RAM|s_memory~22feeder_combout\ : std_logic;
...
SIGNAL \RAM|s_memory~103feeder_combout\ : std_logic;
...
SIGNAL \RAM|s_memory~82feeder_combout\ : std_logic;
...
SIGNAL \RAM|s_memory~98feeder_combout\ : std_logic;
...
SIGNAL \RAM|s_memory~35feeder_combout\ : std_logic;
...
SIGNAL \RAM|s_memory~131feeder_combout\ : std_logic;
SIGNAL \RAM|s_memory~131_q\ : std_logic;
SIGNAL \RAM|s_memory~139_q\ : std_logic;
SIGNAL \RAM|s_memory~123feeder_combout\ : std_logic;
...
SIGNAL \RAM|s_memory~60feeder_combout\ : std_logic;
...
SIGNAL \RAM|s_memory~76feeder_combout\ : std_logic;
...
-- Equation(s):
-- \RAM|s_memory~53feeder_combout\ = \SW[5]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~229_combout\ = (\SW[3]~input_o\ & (!\SW[2]~input_o\ & (!\SW[4]~input_o\ & \SW[1]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~230_combout\ = (\SW[0]~input_o\ & \RAM|s_memory~229_combout\)
...
-- Equation(s):
-- \RAM|s_memory~235_combout\ = (\SW[3]~input_o\ & (\SW[2]~input_o\ & (!\SW[4]~input_o\ & \SW[1]~input_o\)))
...
-- pragma translate_on
PORT MAP (
	datab => \RAM|s_memory~235_combout\,
	datac => \SW[0]~input_o\,
...
-- Equation(s):
-- \RAM|s_memory~231_combout\ = (\SW[3]~input_o\ & (!\SW[4]~input_o\ & (!\SW[1]~input_o\ & \SW[2]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~232_combout\ = (\RAM|s_memory~231_combout\ & \SW[0]~input_o\)
...
-- Equation(s):
-- \RAM|s_memory~233_combout\ = (\SW[3]~input_o\ & (!\SW[2]~input_o\ & (!\SW[4]~input_o\ & !\SW[1]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~234_combout\ = (\SW[0]~input_o\ & \RAM|s_memory~233_combout\)
...
-- Equation(s):
-- \RAM|s_memory~143_combout\ = (\SW[2]~input_o\ & ((\RAM|s_memory~61_q\) # ((\SW[1]~input_o\)))) # (!\SW[2]~input_o\ & (((\RAM|s_memory~45_q\ & !\SW[1]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~144_combout\ = (\SW[1]~input_o\ & ((\RAM|s_memory~143_combout\ & ((\RAM|s_memory~69_q\))) # (!\RAM|s_memory~143_combout\ & (\RAM|s_memory~53_q\)))) # (!\SW[1]~input_o\ & (((\RAM|s_memory~143_combout\))))
...
-- Equation(s):
-- \RAM|s_memory~237_combout\ = (!\SW[3]~input_o\ & (\SW[2]~input_o\ & (!\SW[4]~input_o\ & !\SW[1]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~243_combout\ = (!\SW[3]~input_o\ & (\SW[1]~input_o\ & (\SW[2]~input_o\ & !\SW[4]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~244_combout\ = (\RAM|s_memory~243_combout\ & \SW[0]~input_o\)
...
-- pragma translate_on
PORT MAP (
	datab => \RAM|s_memory~243_combout\,
	datac => \SW[0]~input_o\,
...
-- Equation(s):
-- \RAM|s_memory~239_combout\ = (!\SW[3]~input_o\ & (\SW[1]~input_o\ & (!\SW[2]~input_o\ & !\SW[4]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~241_combout\ = (!\SW[3]~input_o\ & (!\SW[1]~input_o\ & (!\SW[2]~input_o\ & !\SW[4]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~242_combout\ = (\RAM|s_memory~241_combout\ & \SW[0]~input_o\)
...
-- pragma translate_on
PORT MAP (
	datab => \RAM|s_memory~241_combout\,
	datac => \SW[0]~input_o\,
...
-- Equation(s):
-- \RAM|s_memory~145_combout\ = (\SW[1]~input_o\ & ((\RAM|s_memory~21_q\) # ((\SW[2]~input_o\)))) # (!\SW[1]~input_o\ & (((\RAM|s_memory~13_q\ & !\SW[2]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~146_combout\ = (\SW[2]~input_o\ & ((\RAM|s_memory~145_combout\ & ((\RAM|s_memory~37_q\))) # (!\RAM|s_memory~145_combout\ & (\RAM|s_memory~29_q\)))) # (!\SW[2]~input_o\ & (((\RAM|s_memory~145_combout\))))
...
PORT MAP (
	...
	datad => \RAM|s_memory~145_combout\,
	combout => \RAM|s_memory~146_combout\);

-- Location: LCCOMB_X114_Y36_N12
\RAM|s_memory~147\ : cycloneive_lcell_comb
-- Equation(s):
-- \RAM|s_memory~147_combout\ = (\SW[3]~input_o\ & ((\RAM|s_memory~144_combout\) # ((\SW[4]~input_o\)))) # (!\SW[3]~input_o\ & (((\RAM|s_memory~146_combout\ & !\SW[4]~input_o\))))
...
PORT MAP (
	...
	datab => \SW[3]~input_o\,
	datac => \RAM|s_memory~146_combout\,
	datad => \SW[4]~input_o\,
...
-- Equation(s):
-- \RAM|s_memory~125feeder_combout\ = \SW[5]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~247_combout\ = (\SW[3]~input_o\ & (\SW[2]~input_o\ & (!\SW[1]~input_o\ & \SW[4]~input_o\)))
...
-- pragma translate_on
PORT MAP (
	datab => \RAM|s_memory~247_combout\,
	datac => \SW[0]~input_o\,
...
-- Equation(s):
-- \RAM|s_memory~249_combout\ = (\SW[3]~input_o\ & (\SW[4]~input_o\ & (!\SW[1]~input_o\ & !\SW[2]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~250_combout\ = (\SW[0]~input_o\ & \RAM|s_memory~249_combout\)
...
-- Equation(s):
-- \RAM|s_memory~148_combout\ = (\SW[1]~input_o\ & (((\SW[2]~input_o\)))) # (!\SW[1]~input_o\ & ((\SW[2]~input_o\ & (\RAM|s_memory~125_q\)) # (!\SW[2]~input_o\ & ((\RAM|s_memory~109_q\)))))
...
-- Equation(s):
-- \RAM|s_memory~245_combout\ = (\SW[3]~input_o\ & (\SW[1]~input_o\ & (!\SW[2]~input_o\ & \SW[4]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~246_combout\ = (\RAM|s_memory~245_combout\ & \SW[0]~input_o\)
...
-- pragma translate_on
PORT MAP (
	datab => \RAM|s_memory~245_combout\,
	datac => \SW[0]~input_o\,
...
-- Equation(s):
-- \RAM|s_memory~251_combout\ = (\SW[3]~input_o\ & (\SW[1]~input_o\ & (\SW[2]~input_o\ & \SW[4]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~252_combout\ = (\RAM|s_memory~251_combout\ & \SW[0]~input_o\)
...
-- pragma translate_on
PORT MAP (
	datab => \RAM|s_memory~251_combout\,
	datac => \SW[0]~input_o\,
...
-- Equation(s):
-- \RAM|s_memory~149_combout\ = (\RAM|s_memory~148_combout\ & (((\RAM|s_memory~133_q\) # (!\SW[1]~input_o\)))) # (!\RAM|s_memory~148_combout\ & (\RAM|s_memory~117_q\ & ((\SW[1]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~223_combout\ = (!\SW[3]~input_o\ & (\SW[1]~input_o\ & (!\SW[2]~input_o\ & \SW[4]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~224_combout\ = (\RAM|s_memory~223_combout\ & \SW[0]~input_o\)
...
-- pragma translate_on
PORT MAP (
	dataa => \RAM|s_memory~223_combout\,
	datac => \SW[0]~input_o\,
...
-- Equation(s):
-- \RAM|s_memory~225_combout\ = (!\SW[3]~input_o\ & (!\SW[2]~input_o\ & (\SW[4]~input_o\ & !\SW[1]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~141_combout\ = (\SW[2]~input_o\ & (((\SW[1]~input_o\)))) # (!\SW[2]~input_o\ & ((\SW[1]~input_o\ & (\RAM|s_memory~85_q\)) # (!\SW[1]~input_o\ & ((\RAM|s_memory~77_q\)))))
...
-- Equation(s):
-- \RAM|s_memory~227_combout\ = (!\SW[3]~input_o\ & (\SW[2]~input_o\ & (\SW[4]~input_o\ & \SW[1]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~228_combout\ = (\SW[0]~input_o\ & \RAM|s_memory~227_combout\)
...
PORT MAP (
	datac => \SW[0]~input_o\,
	datad => \RAM|s_memory~227_combout\,
...
-- Equation(s):
-- \RAM|s_memory~221_combout\ = (!\SW[3]~input_o\ & (!\SW[1]~input_o\ & (\SW[2]~input_o\ & \SW[4]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~222_combout\ = (\RAM|s_memory~221_combout\ & \SW[0]~input_o\)
...
-- pragma translate_on
PORT MAP (
	datab => \RAM|s_memory~221_combout\,
	datac => \SW[0]~input_o\,
...
-- Equation(s):
-- \RAM|s_memory~142_combout\ = (\RAM|s_memory~141_combout\ & (((\RAM|s_memory~101_q\)) # (!\SW[2]~input_o\))) # (!\RAM|s_memory~141_combout\ & (\SW[2]~input_o\ & ((\RAM|s_memory~93_q\))))
...
-- Equation(s):
-- \RAM|s_memory~150_combout\ = (\RAM|s_memory~147_combout\ & ((\RAM|s_memory~149_combout\) # ((!\SW[4]~input_o\)))) # (!\RAM|s_memory~147_combout\ & (((\RAM|s_memory~142_combout\ & \SW[4]~input_o\))))
...
PORT MAP (
	...
	datac => \RAM|s_memory~142_combout\,
	datad => \SW[4]~input_o\,
...
\RAM|s_memory~94feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \RAM|s_memory~94feeder_combout\ = \SW[6]~input_o\
...
PORT MAP (
	datad => \SW[6]~input_o\,
	combout => \RAM|s_memory~94feeder_combout\);
...
PORT MAP (
	clk => \KEY[0]~input_o\,
	d => \RAM|s_memory~94feeder_combout\,
	ena => \RAM|s_memory~222_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \RAM|s_memory~94_q\);
...
-- Equation(s):
-- \RAM|s_memory~151_combout\ = (\SW[4]~input_o\ & ((\RAM|s_memory~94_q\) # ((\SW[3]~input_o\)))) # (!\SW[4]~input_o\ & (((\RAM|s_memory~30_q\ & !\SW[3]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~152_combout\ = (\RAM|s_memory~151_combout\ & (((\RAM|s_memory~126_q\) # (!\SW[3]~input_o\)))) # (!\RAM|s_memory~151_combout\ & (\RAM|s_memory~62_q\ & ((\SW[3]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~155_combout\ = (\SW[3]~input_o\ & (\SW[4]~input_o\)) # (!\SW[3]~input_o\ & ((\SW[4]~input_o\ & ((\RAM|s_memory~78_q\))) # (!\SW[4]~input_o\ & (\RAM|s_memory~14_q\))))
...
-- Equation(s):
-- \RAM|s_memory~46feeder_combout\ = \SW[6]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~156_combout\ = (\SW[3]~input_o\ & ((\RAM|s_memory~155_combout\ & (\RAM|s_memory~110_q\)) # (!\RAM|s_memory~155_combout\ & ((\RAM|s_memory~46_q\))))) # (!\SW[3]~input_o\ & (\RAM|s_memory~155_combout\))
...
-- Equation(s):
-- \RAM|s_memory~54feeder_combout\ = \SW[6]~input_o\
...
\RAM|s_memory~22feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \RAM|s_memory~22feeder_combout\ = \SW[6]~input_o\
...
PORT MAP (
	datad => \SW[6]~input_o\,
	combout => \RAM|s_memory~22feeder_combout\);
...
PORT MAP (
	clk => \KEY[0]~input_o\,
	d => \RAM|s_memory~22feeder_combout\,
	ena => \RAM|s_memory~240_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \RAM|s_memory~22_q\);
...
-- Equation(s):
-- \RAM|s_memory~153_combout\ = (\SW[3]~input_o\ & ((\RAM|s_memory~54_q\) # ((\SW[4]~input_o\)))) # (!\SW[3]~input_o\ & (((\RAM|s_memory~22_q\ & !\SW[4]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~154_combout\ = (\RAM|s_memory~153_combout\ & (((\RAM|s_memory~118_q\) # (!\SW[4]~input_o\)))) # (!\RAM|s_memory~153_combout\ & (\RAM|s_memory~86_q\ & ((\SW[4]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~157_combout\ = (\SW[2]~input_o\ & (((\SW[1]~input_o\)))) # (!\SW[2]~input_o\ & ((\SW[1]~input_o\ & ((\RAM|s_memory~154_combout\))) # (!\SW[1]~input_o\ & (\RAM|s_memory~156_combout\))))
...
-- Equation(s):
-- \RAM|s_memory~70feeder_combout\ = \SW[6]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~158_combout\ = (\SW[3]~input_o\ & ((\RAM|s_memory~70_q\) # ((\SW[4]~input_o\)))) # (!\SW[3]~input_o\ & (((\RAM|s_memory~38_q\ & !\SW[4]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~159_combout\ = (\RAM|s_memory~158_combout\ & (((\RAM|s_memory~134_q\) # (!\SW[4]~input_o\)))) # (!\RAM|s_memory~158_combout\ & (\RAM|s_memory~102_q\ & ((\SW[4]~input_o\))))
...
PORT MAP (
	...
	datac => \RAM|s_memory~159_combout\,
	datad => \SW[2]~input_o\,
...
-- Equation(s):
-- \RAM|s_memory~55feeder_combout\ = \SW[7]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~161_combout\ = (\SW[2]~input_o\ & (\SW[1]~input_o\)) # (!\SW[2]~input_o\ & ((\SW[1]~input_o\ & ((\RAM|s_memory~55_q\))) # (!\SW[1]~input_o\ & (\RAM|s_memory~47_q\))))
...
-- Equation(s):
-- \RAM|s_memory~162_combout\ = (\RAM|s_memory~161_combout\ & (((\RAM|s_memory~71_q\) # (!\SW[2]~input_o\)))) # (!\RAM|s_memory~161_combout\ & (\RAM|s_memory~63_q\ & ((\SW[2]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~127feeder_combout\ = \SW[7]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~168_combout\ = (\SW[1]~input_o\ & ((\RAM|s_memory~119_q\) # ((\SW[2]~input_o\)))) # (!\SW[1]~input_o\ & (((\RAM|s_memory~111_q\ & !\SW[2]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~169_combout\ = (\SW[2]~input_o\ & ((\RAM|s_memory~168_combout\ & ((\RAM|s_memory~135_q\))) # (!\RAM|s_memory~168_combout\ & (\RAM|s_memory~127_q\)))) # (!\SW[2]~input_o\ & (((\RAM|s_memory~168_combout\))))
...
PORT MAP (
	dataa => \SW[2]~input_o\,
	datab => \RAM|s_memory~127_q\,
	datac => \RAM|s_memory~135_q\,
	datad => \RAM|s_memory~168_combout\,
...
-- Equation(s):
-- \RAM|s_memory~165_combout\ = (\SW[1]~input_o\ & (((\SW[2]~input_o\)))) # (!\SW[1]~input_o\ & ((\SW[2]~input_o\ & (\RAM|s_memory~31_q\)) # (!\SW[2]~input_o\ & ((\RAM|s_memory~15_q\)))))
...
-- Equation(s):
-- \RAM|s_memory~166_combout\ = (\RAM|s_memory~165_combout\ & (((\RAM|s_memory~39_q\) # (!\SW[1]~input_o\)))) # (!\RAM|s_memory~165_combout\ & (\RAM|s_memory~23_q\ & ((\SW[1]~input_o\))))
...
PORT MAP (
	...
	datab => \RAM|s_memory~23_q\,
	datac => \RAM|s_memory~39_q\,
	datad => \SW[1]~input_o\,
	combout => \RAM|s_memory~166_combout\);

-- Location: LCCOMB_X112_Y40_N6
\RAM|s_memory~103feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \RAM|s_memory~103feeder_combout\ = \SW[7]~input_o\
...
PORT MAP (
	datad => \SW[7]~input_o\,
	combout => \RAM|s_memory~103feeder_combout\);
...
PORT MAP (
	clk => \KEY[0]~input_o\,
	d => \RAM|s_memory~103feeder_combout\,
	ena => \RAM|s_memory~228_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \RAM|s_memory~163_combout\ = (\SW[2]~input_o\ & ((\SW[1]~input_o\) # ((\RAM|s_memory~95_q\)))) # (!\SW[2]~input_o\ & (!\SW[1]~input_o\ & (\RAM|s_memory~79_q\)))
...
-- Equation(s):
-- \RAM|s_memory~164_combout\ = (\RAM|s_memory~163_combout\ & ((\RAM|s_memory~103_q\) # ((!\SW[1]~input_o\)))) # (!\RAM|s_memory~163_combout\ & (((\RAM|s_memory~87_q\ & \SW[1]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~167_combout\ = (\SW[4]~input_o\ & (((\SW[3]~input_o\) # (\RAM|s_memory~164_combout\)))) # (!\SW[4]~input_o\ & (\RAM|s_memory~166_combout\ & (!\SW[3]~input_o\)))
...
PORT MAP (
	...
	datab => \SW[4]~input_o\,
	datac => \SW[3]~input_o\,
	datad => \RAM|s_memory~164_combout\,
...
PORT MAP (
	...
	datab => \RAM|s_memory~169_combout\,
	datac => \RAM|s_memory~167_combout\,
	datad => \SW[3]~input_o\,
...
-- Equation(s):
-- \RAM|s_memory~175_combout\ = (\SW[3]~input_o\ & ((\SW[4]~input_o\) # ((\RAM|s_memory~48_q\)))) # (!\SW[3]~input_o\ & (!\SW[4]~input_o\ & (\RAM|s_memory~16_q\)))
...
-- Equation(s):
-- \RAM|s_memory~176_combout\ = (\SW[4]~input_o\ & ((\RAM|s_memory~175_combout\ & ((\RAM|s_memory~112_q\))) # (!\RAM|s_memory~175_combout\ & (\RAM|s_memory~80_q\)))) # (!\SW[4]~input_o\ & (((\RAM|s_memory~175_combout\))))
...
-- Equation(s):
-- \RAM|s_memory~173_combout\ = (\SW[4]~input_o\ & (((\SW[3]~input_o\)))) # (!\SW[4]~input_o\ & ((\SW[3]~input_o\ & (\RAM|s_memory~64_q\)) # (!\SW[3]~input_o\ & ((\RAM|s_memory~32_q\)))))
...
-- Equation(s):
-- \RAM|s_memory~174_combout\ = (\RAM|s_memory~173_combout\ & ((\RAM|s_memory~128_q\) # ((!\SW[4]~input_o\)))) # (!\RAM|s_memory~173_combout\ & (((\RAM|s_memory~96_q\ & \SW[4]~input_o\))))
...
PORT MAP (
	...
	datab => \RAM|s_memory~128_q\,
	datac => \RAM|s_memory~96_q\,
	datad => \SW[4]~input_o\,
...
-- Equation(s):
-- \RAM|s_memory~178_combout\ = (\SW[4]~input_o\ & ((\RAM|s_memory~104_q\) # ((\SW[3]~input_o\)))) # (!\SW[4]~input_o\ & (((\RAM|s_memory~40_q\ & !\SW[3]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~179_combout\ = (\SW[3]~input_o\ & ((\RAM|s_memory~178_combout\ & ((\RAM|s_memory~136_q\))) # (!\RAM|s_memory~178_combout\ & (\RAM|s_memory~72_q\)))) # (!\SW[3]~input_o\ & (((\RAM|s_memory~178_combout\))))
...
PORT MAP (
	dataa => \SW[3]~input_o\,
	datab => \RAM|s_memory~72_q\,
	datac => \RAM|s_memory~136_q\,
	datad => \RAM|s_memory~178_combout\,
...
-- Equation(s):
-- \RAM|s_memory~171_combout\ = (\SW[3]~input_o\ & (\SW[4]~input_o\)) # (!\SW[3]~input_o\ & ((\SW[4]~input_o\ & ((\RAM|s_memory~88_q\))) # (!\SW[4]~input_o\ & (\RAM|s_memory~24_q\))))
...
-- Equation(s):
-- \RAM|s_memory~172_combout\ = (\RAM|s_memory~171_combout\ & (((\RAM|s_memory~120_q\) # (!\SW[3]~input_o\)))) # (!\RAM|s_memory~171_combout\ & (\RAM|s_memory~56_q\ & ((\SW[3]~input_o\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \RAM|s_memory~177_combout\,
	datab => \RAM|s_memory~179_combout\,
	datac => \RAM|s_memory~172_combout\,
	datad => \SW[1]~input_o\,
...
-- Equation(s):
-- \RAM|s_memory~188_combout\ = (\SW[1]~input_o\ & (((\SW[2]~input_o\)))) # (!\SW[1]~input_o\ & ((\SW[2]~input_o\ & (\RAM|s_memory~129_q\)) # (!\SW[2]~input_o\ & ((\RAM|s_memory~113_q\)))))
...
-- Equation(s):
-- \RAM|s_memory~189_combout\ = (\RAM|s_memory~188_combout\ & (((\RAM|s_memory~137_q\) # (!\SW[1]~input_o\)))) # (!\RAM|s_memory~188_combout\ & (\RAM|s_memory~121_q\ & ((\SW[1]~input_o\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \RAM|s_memory~121_q\,
	datab => \RAM|s_memory~188_combout\,
...
-- Equation(s):
-- \RAM|s_memory~183_combout\ = (\SW[2]~input_o\ & ((\RAM|s_memory~65_q\) # ((\SW[1]~input_o\)))) # (!\SW[2]~input_o\ & (((\RAM|s_memory~49_q\ & !\SW[1]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~184_combout\ = (\RAM|s_memory~183_combout\ & (((\RAM|s_memory~73_q\) # (!\SW[1]~input_o\)))) # (!\RAM|s_memory~183_combout\ & (\RAM|s_memory~57_q\ & ((\SW[1]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~185_combout\ = (\SW[1]~input_o\ & ((\SW[2]~input_o\) # ((\RAM|s_memory~25_q\)))) # (!\SW[1]~input_o\ & (!\SW[2]~input_o\ & (\RAM|s_memory~17_q\)))
...
-- Equation(s):
-- \RAM|s_memory~186_combout\ = (\SW[2]~input_o\ & ((\RAM|s_memory~185_combout\ & ((\RAM|s_memory~41_q\))) # (!\RAM|s_memory~185_combout\ & (\RAM|s_memory~33_q\)))) # (!\SW[2]~input_o\ & (((\RAM|s_memory~185_combout\))))
...
-- Equation(s):
-- \RAM|s_memory~187_combout\ = (\SW[3]~input_o\ & ((\RAM|s_memory~184_combout\) # ((\SW[4]~input_o\)))) # (!\SW[3]~input_o\ & (((\RAM|s_memory~186_combout\ & !\SW[4]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~181_combout\ = (\SW[2]~input_o\ & (((\SW[1]~input_o\)))) # (!\SW[2]~input_o\ & ((\SW[1]~input_o\ & (\RAM|s_memory~89_q\)) # (!\SW[1]~input_o\ & ((\RAM|s_memory~81_q\)))))
...
-- Equation(s):
-- \RAM|s_memory~182_combout\ = (\RAM|s_memory~181_combout\ & (((\RAM|s_memory~105_q\)) # (!\SW[2]~input_o\))) # (!\RAM|s_memory~181_combout\ & (\SW[2]~input_o\ & ((\RAM|s_memory~97_q\))))
...
-- Equation(s):
-- \RAM|s_memory~50feeder_combout\ = \SW[10]~input_o\
...
\RAM|s_memory~82feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \RAM|s_memory~82feeder_combout\ = \SW[10]~input_o\
...
PORT MAP (
	datad => \SW[10]~input_o\,
	combout => \RAM|s_memory~82feeder_combout\);
...
PORT MAP (
	clk => \KEY[0]~input_o\,
	d => \RAM|s_memory~82feeder_combout\,
	ena => \RAM|s_memory~226_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \RAM|s_memory~82_q\);
...
-- Equation(s):
-- \RAM|s_memory~195_combout\ = (\SW[3]~input_o\ & (\SW[4]~input_o\)) # (!\SW[3]~input_o\ & ((\SW[4]~input_o\ & ((\RAM|s_memory~82_q\))) # (!\SW[4]~input_o\ & (\RAM|s_memory~18_q\))))
...
-- Equation(s):
-- \RAM|s_memory~196_combout\ = (\RAM|s_memory~195_combout\ & (((\RAM|s_memory~114_q\) # (!\SW[3]~input_o\)))) # (!\RAM|s_memory~195_combout\ & (\RAM|s_memory~50_q\ & ((\SW[3]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~58feeder_combout\ = \SW[10]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~193_combout\ = (\SW[3]~input_o\ & ((\SW[4]~input_o\) # ((\RAM|s_memory~58_q\)))) # (!\SW[3]~input_o\ & (!\SW[4]~input_o\ & (\RAM|s_memory~26_q\)))
...
-- Equation(s):
-- \RAM|s_memory~194_combout\ = (\RAM|s_memory~193_combout\ & (((\RAM|s_memory~122_q\) # (!\SW[4]~input_o\)))) # (!\RAM|s_memory~193_combout\ & (\RAM|s_memory~90_q\ & ((\SW[4]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~197_combout\ = (\SW[1]~input_o\ & (((\RAM|s_memory~194_combout\) # (\SW[2]~input_o\)))) # (!\SW[1]~input_o\ & (\RAM|s_memory~196_combout\ & ((!\SW[2]~input_o\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \RAM|s_memory~196_combout\,
...
\RAM|s_memory~98feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \RAM|s_memory~98feeder_combout\ = \SW[10]~input_o\
...
PORT MAP (
	datad => \SW[10]~input_o\,
	combout => \RAM|s_memory~98feeder_combout\);
...
PORT MAP (
	clk => \KEY[0]~input_o\,
	d => \RAM|s_memory~98feeder_combout\,
	ena => \RAM|s_memory~222_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \RAM|s_memory~98_q\);
...
-- Equation(s):
-- \RAM|s_memory~191_combout\ = (\SW[3]~input_o\ & (((\SW[4]~input_o\)))) # (!\SW[3]~input_o\ & ((\SW[4]~input_o\ & (\RAM|s_memory~98_q\)) # (!\SW[4]~input_o\ & ((\RAM|s_memory~34_q\)))))
...
-- Equation(s):
-- \RAM|s_memory~192_combout\ = (\RAM|s_memory~191_combout\ & (((\RAM|s_memory~130_q\) # (!\SW[3]~input_o\)))) # (!\RAM|s_memory~191_combout\ & (\RAM|s_memory~66_q\ & ((\SW[3]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~106feeder_combout\ = \SW[10]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~74feeder_combout\ = \SW[10]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~198_combout\ = (\SW[4]~input_o\ & (((\SW[3]~input_o\)))) # (!\SW[4]~input_o\ & ((\SW[3]~input_o\ & (\RAM|s_memory~74_q\)) # (!\SW[3]~input_o\ & ((\RAM|s_memory~42_q\)))))
...
-- Equation(s):
-- \RAM|s_memory~199_combout\ = (\RAM|s_memory~198_combout\ & (((\RAM|s_memory~138_q\) # (!\SW[4]~input_o\)))) # (!\RAM|s_memory~198_combout\ & (\RAM|s_memory~106_q\ & ((\SW[4]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~200_combout\ = (\RAM|s_memory~197_combout\ & (((\RAM|s_memory~199_combout\)) # (!\SW[2]~input_o\))) # (!\RAM|s_memory~197_combout\ & (\SW[2]~input_o\ & (\RAM|s_memory~192_combout\)))
...
PORT MAP (
	...
	datab => \SW[2]~input_o\,
	datac => \RAM|s_memory~192_combout\,
	datad => \RAM|s_memory~199_combout\,
...
-- Equation(s):
-- \RAM|s_memory~201_combout\ = (\SW[2]~input_o\ & (((\SW[1]~input_o\)))) # (!\SW[2]~input_o\ & ((\SW[1]~input_o\ & (\RAM|s_memory~59_q\)) # (!\SW[1]~input_o\ & ((\RAM|s_memory~51_q\)))))
...
-- Equation(s):
-- \RAM|s_memory~202_combout\ = (\RAM|s_memory~201_combout\ & (((\RAM|s_memory~75_q\) # (!\SW[2]~input_o\)))) # (!\RAM|s_memory~201_combout\ & (\RAM|s_memory~67_q\ & ((\SW[2]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~27feeder_combout\ = \SW[11]~input_o\
...
\RAM|s_memory~35feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \RAM|s_memory~35feeder_combout\ = \SW[11]~input_o\
...
PORT MAP (
	datad => \SW[11]~input_o\,
	combout => \RAM|s_memory~35feeder_combout\);
...
PORT MAP (
	clk => \KEY[0]~input_o\,
	d => \RAM|s_memory~35feeder_combout\,
	ena => \RAM|s_memory~238_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \RAM|s_memory~35_q\);
...
-- Equation(s):
-- \RAM|s_memory~205_combout\ = (\SW[1]~input_o\ & (\SW[2]~input_o\)) # (!\SW[1]~input_o\ & ((\SW[2]~input_o\ & ((\RAM|s_memory~35_q\))) # (!\SW[2]~input_o\ & (\RAM|s_memory~19_q\))))
...
-- Equation(s):
-- \RAM|s_memory~206_combout\ = (\RAM|s_memory~205_combout\ & (((\RAM|s_memory~43_q\) # (!\SW[1]~input_o\)))) # (!\RAM|s_memory~205_combout\ & (\RAM|s_memory~27_q\ & ((\SW[1]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~203_combout\ = (\SW[2]~input_o\ & ((\RAM|s_memory~99_q\) # ((\SW[1]~input_o\)))) # (!\SW[2]~input_o\ & (((\RAM|s_memory~83_q\ & !\SW[1]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~204_combout\ = (\SW[1]~input_o\ & ((\RAM|s_memory~203_combout\ & (\RAM|s_memory~107_q\)) # (!\RAM|s_memory~203_combout\ & ((\RAM|s_memory~91_q\))))) # (!\SW[1]~input_o\ & (\RAM|s_memory~203_combout\))
...
PORT MAP (
	dataa => \SW[1]~input_o\,
	datab => \RAM|s_memory~203_combout\,
	datac => \RAM|s_memory~107_q\,
	datad => \RAM|s_memory~91_q\,
	combout => \RAM|s_memory~204_combout\);

-- Location: LCCOMB_X114_Y39_N14
\RAM|s_memory~207\ : cycloneive_lcell_comb
-- Equation(s):
-- \RAM|s_memory~207_combout\ = (\SW[4]~input_o\ & (((\SW[3]~input_o\) # (\RAM|s_memory~204_combout\)))) # (!\SW[4]~input_o\ & (\RAM|s_memory~206_combout\ & (!\SW[3]~input_o\)))
...
\RAM|s_memory~131feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \RAM|s_memory~131feeder_combout\ = \SW[11]~input_o\
...
PORT MAP (
	datad => \SW[11]~input_o\,
	combout => \RAM|s_memory~131feeder_combout\);
...
PORT MAP (
	clk => \KEY[0]~input_o\,
	d => \RAM|s_memory~131feeder_combout\,
	ena => \RAM|s_memory~248_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\RAM|s_memory~123feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \RAM|s_memory~123feeder_combout\ = \SW[11]~input_o\
...
PORT MAP (
	datad => \SW[11]~input_o\,
	combout => \RAM|s_memory~123feeder_combout\);
...
PORT MAP (
	clk => \KEY[0]~input_o\,
	d => \RAM|s_memory~123feeder_combout\,
	ena => \RAM|s_memory~246_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \RAM|s_memory~208_combout\ = (\SW[1]~input_o\ & ((\RAM|s_memory~123_q\) # ((\SW[2]~input_o\)))) # (!\SW[1]~input_o\ & (((\RAM|s_memory~115_q\ & !\SW[2]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~209_combout\ = (\SW[2]~input_o\ & ((\RAM|s_memory~208_combout\ & ((\RAM|s_memory~139_q\))) # (!\RAM|s_memory~208_combout\ & (\RAM|s_memory~131_q\)))) # (!\SW[2]~input_o\ & (((\RAM|s_memory~208_combout\))))
...
-- Equation(s):
-- \RAM|s_memory~210_combout\ = (\RAM|s_memory~207_combout\ & (((\RAM|s_memory~209_combout\) # (!\SW[3]~input_o\)))) # (!\RAM|s_memory~207_combout\ & (\RAM|s_memory~202_combout\ & (\SW[3]~input_o\)))
...
PORT MAP (
	...
	datac => \SW[3]~input_o\,
	datad => \RAM|s_memory~209_combout\,
...
-- Equation(s):
-- \RAM|s_memory~52feeder_combout\ = \SW[12]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~215_combout\ = (\SW[3]~input_o\ & ((\SW[4]~input_o\) # ((\RAM|s_memory~52_q\)))) # (!\SW[3]~input_o\ & (!\SW[4]~input_o\ & (\RAM|s_memory~20_q\)))
...
-- Equation(s):
-- \RAM|s_memory~216_combout\ = (\RAM|s_memory~215_combout\ & (((\RAM|s_memory~116_q\) # (!\SW[4]~input_o\)))) # (!\RAM|s_memory~215_combout\ & (\RAM|s_memory~84_q\ & ((\SW[4]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~68feeder_combout\ = \SW[12]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~213_combout\ = (\SW[3]~input_o\ & ((\RAM|s_memory~68_q\) # ((\SW[4]~input_o\)))) # (!\SW[3]~input_o\ & (((\RAM|s_memory~36_q\ & !\SW[4]~input_o\))))
...
-- Equation(s):
-- \RAM|s_memory~214_combout\ = (\RAM|s_memory~213_combout\ & (((\RAM|s_memory~132_q\) # (!\SW[4]~input_o\)))) # (!\RAM|s_memory~213_combout\ & (\RAM|s_memory~100_q\ & ((\SW[4]~input_o\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \RAM|s_memory~213_combout\,
...
-- Equation(s):
-- \RAM|s_memory~217_combout\ = (\SW[1]~input_o\ & (((\SW[2]~input_o\)))) # (!\SW[1]~input_o\ & ((\SW[2]~input_o\ & ((\RAM|s_memory~214_combout\))) # (!\SW[2]~input_o\ & (\RAM|s_memory~216_combout\))))
...
\RAM|s_memory~60feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \RAM|s_memory~60feeder_combout\ = \SW[12]~input_o\
...
PORT MAP (
	datad => \SW[12]~input_o\,
	combout => \RAM|s_memory~60feeder_combout\);
...
PORT MAP (
	clk => \KEY[0]~input_o\,
	d => \RAM|s_memory~60feeder_combout\,
	ena => \RAM|s_memory~230_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \RAM|s_memory~60_q\);
...
-- Equation(s):
-- \RAM|s_memory~211_combout\ = (\SW[4]~input_o\ & (((\SW[3]~input_o\) # (\RAM|s_memory~92_q\)))) # (!\SW[4]~input_o\ & (\RAM|s_memory~28_q\ & (!\SW[3]~input_o\)))
...
-- Equation(s):
-- \RAM|s_memory~212_combout\ = (\SW[3]~input_o\ & ((\RAM|s_memory~211_combout\ & ((\RAM|s_memory~124_q\))) # (!\RAM|s_memory~211_combout\ & (\RAM|s_memory~60_q\)))) # (!\SW[3]~input_o\ & (((\RAM|s_memory~211_combout\))))
...
PORT MAP (
	...
	datad => \RAM|s_memory~211_combout\,
	combout => \RAM|s_memory~212_combout\);

-- Location: LCCOMB_X113_Y40_N22
\RAM|s_memory~76feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \RAM|s_memory~76feeder_combout\ = \SW[12]~input_o\
...
PORT MAP (
	datad => \SW[12]~input_o\,
	combout => \RAM|s_memory~76feeder_combout\);
...
PORT MAP (
	clk => \KEY[0]~input_o\,
	d => \RAM|s_memory~76feeder_combout\,
	ena => \RAM|s_memory~236_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \RAM|s_memory~76_q\);
...
-- Equation(s):
-- \RAM|s_memory~108feeder_combout\ = \SW[12]~input_o\
...
-- Equation(s):
-- \RAM|s_memory~218_combout\ = (\SW[3]~input_o\ & (((\SW[4]~input_o\)))) # (!\SW[3]~input_o\ & ((\SW[4]~input_o\ & (\RAM|s_memory~108_q\)) # (!\SW[4]~input_o\ & ((\RAM|s_memory~44_q\)))))
...
-- Equation(s):
-- \RAM|s_memory~219_combout\ = (\RAM|s_memory~218_combout\ & (((\RAM|s_memory~140_q\) # (!\SW[3]~input_o\)))) # (!\RAM|s_memory~218_combout\ & (\RAM|s_memory~76_q\ & ((\SW[3]~input_o\))))
...
PORT MAP (
	...
	datab => \RAM|s_memory~218_combout\,
...
-- Equation(s):
-- \RAM|s_memory~220_combout\ = (\RAM|s_memory~217_combout\ & (((\RAM|s_memory~219_combout\)) # (!\SW[1]~input_o\))) # (!\RAM|s_memory~217_combout\ & (\SW[1]~input_o\ & (\RAM|s_memory~212_combout\)))
...
PORT MAP (
	...
	datab => \SW[1]~input_o\,
	datac => \RAM|s_memory~212_combout\,
