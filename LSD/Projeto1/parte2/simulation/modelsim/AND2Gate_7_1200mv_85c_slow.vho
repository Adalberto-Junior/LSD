...
-- Design Ports Information
-- outPort	=>  Location: PIN_A18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- inPort	=>  Location: PIN_B18,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
\inPort~input\ : cycloneive_io_ibuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	simulate_z_as => "z")
